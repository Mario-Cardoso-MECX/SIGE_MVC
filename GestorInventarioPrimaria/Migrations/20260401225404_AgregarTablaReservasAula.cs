...
{
    /// <inheritdoc />
    public partial class AgregarTablaReservasAula : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservasAula", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservasAula_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservasAula_UsuarioId",
                table: "ReservasAula",
                column: "UsuarioId");
        }
